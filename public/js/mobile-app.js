/**
 * First National Bank Platform â€” Interactive Mobile Banking App Simulator (iPhone 16 Pro)
    ...
    const MobileApp = {
                ...
                <div id="mMainView" style="display:${this.isUnlocked ? 'flex' : 'none'};flex-direction:column;height:100%;">
                    ...
                    <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:14px;">
                        ...
                        <div style="display:flex;align-items:center;gap:6px;">
                            ...
                            <button type="button" class="btn-m-card-action" onclick="MobileApp.lockApp()" title="Lock phone" style="padding:2px 6px;">ðŸ”’</button>
                        </div>
                    </div>
                    ...
                    <div id="mSub_home" class="m-subview active">
                        ...
                        <div class="mobile-balance-card">
                            ...
                            <div id="mPrimaryBalance" style="font-size:24px;font-weight:800;margin:6px 0;letter-spacing:-0.5px;">USD 3,420,850.00</div>
                            <div id="mPrimaryIban" style="font-size:10px;color:rgba(255,255,255,0.85);font-family:monospace;">US89APEX00007029841001</div>
                        </div>
                        ...
                        <div class="m-cards-carousel">
                            ...
                            <div class="m-card-controls">
                                <div style="display:flex;gap:4px;">
                                    <button type="button" class="btn-m-card-action" onclick="MobileApp.revealCardDetails()">ðŸ‘ï¸ Details</button>
                                    <button type="button" class="btn-m-card-action" onclick="MobileApp.toggleFreezeCard()">â„ï¸ Freeze</button>
                                </div>
                                <div style="display:flex;gap:4px;">
                                    <button type="button" class="btn-m-card-action" onclick="MobileApp.prevCard()">â—€</button>
                                    <button type="button" class="btn-m-card-action" onclick="MobileApp.nextCard()">â–¶</button>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="mSub_transfer" class="m-subview">
                        <div style="display:flex;align-items:center;gap:8px;margin-bottom:14px;">
                            <button type="button" class="btn-m-card-action" onclick="MobileApp.switchSubView('home')">â† Back</button>
                        ...
                        <form id="mTransferForm" onsubmit="MobileApp.handleMobileTransfer(event)">
                            <div class="field" style="margin-bottom:10px;">
                                ...
                                <input type="text" id="mTransferBeneficiary" placeholder="Apex Technologies Corp" style="padding:8px;font-size:12px;" required>
                            </div>
                            <div class="field" style="margin-bottom:10px;">
                                <label style="font-size:10px;">Account / Routing / IBAN</label>
                                <input type="text" id="mTransferIbanInput" placeholder="US44033000008892100412" style="padding:8px;font-size:12px;" required>
                            </div>
                    ...
                    <div id="mSub_scanner" class="m-subview">
                        ...
                        <div style="display:flex;gap:6px;margin-bottom:10px;">
                            <button type="button" class="btn-m-card-action" style="flex:1;padding:6px 4px;font-size:10px;" onclick="MobileApp.handleMobileScannerUpload('passport')">ðŸ“¸ Scan Passport</button>
                            <button type="button" class="btn-m-card-action" style="flex:1;padding:6px 4px;font-size:10px;" onclick="MobileApp.handleMobileScannerUpload('licence')">ðŸ“‘ Scan Certificate</button>
                        </div>
                    ...
                    <div id="mSub_fx" class="m-subview">
                        ...
                        <div style="display:flex;flex-direction:column;gap:8px;">
                            <div class="mtx-item"><span>EUR/USD</span> <strong style="color:#10b981;">1.0850</strong></div>
                            <div class="mtx-item"><span>GBP/USD</span> <strong style="color:#10b981;">1.2720</strong></div>
                            <div class="mtx-item"><span>USD/CAD</span> <strong style="color:#f43f5e;">1.3540</strong></div>
                            <div class="mtx-item"><span>USD/JPY</span> <strong style="color:#10b981;">151.20</strong></div>
                            <div class="mtx-item"><span>USD/CHF</span> <strong style="color:#10b981;">0.8840</strong></div>
                        </div>
                    </div>
        ...
        renderDashboardData(data) {
            ...
            if (balEl && data.primaryBalance) {
                balEl.textContent = 'USD ' + Number(data.primaryBalance.balance).toLocaleString(undefined, {
            ...
            container.innerHTML = cards.map((card, idx) => `
                <div class="m-card-item ${idx === this.activeCardIndex ? 'active' : ''}" style="background: ${card.gradient};" id="mCard_${idx}">
                    <div class="m-card-header">
                        ...
                        <span class="m-card-chip">ðŸ’³</span>
                    </div>
        ...
        revealCardDetails() {
            ...
            if (numEl.dataset.revealed === 'true') {
                numEl.textContent = 'â€¢â€¢â€¢â€¢ â€¢â€¢â€¢â€¢ â€¢â€¢â€¢â€¢ 8842';
        ...
        async handleMobileTransfer(e) {
            ...
            const originalText = btn ? btn.innerHTML : 'âš¡ Send Wire Payment';
            ...
            const currency = document.getElementById('mTransferCurrencyInput')?.value || 'USD';
            ...
            if (btn) {
                btn.disabled = true;
                btn.innerHTML = 'Clearing via Fedwire...';
            }
        ...
        async handleMobileScannerUpload(fileOrPreset) {
            ...
            if (statusEl) statusEl.innerHTML = '<span style="color:#38bdf8;font-size:11px;">ðŸ”„ Processing &amp; Base64 Encoding...</span>';
                    ...
                    if (statusEl) {
                        statusEl.innerHTML = `
                            <div style="background:rgba(16,185,129,0.2);border:1px solid #10b981;border-radius:6px;padding:6px;margin-top:6px;text-align:center;">
                                <strong style="color:#10b981;font-size:11px;">ðŸŸ¢ Stored in DB (Base64)</strong>
