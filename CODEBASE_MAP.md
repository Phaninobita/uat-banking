...
| **Creative Yellow Login** | `/login` | [`web/public/login/index.html`](file:///c:/DEVELOPMENT/banking-demo/banking-demo/web/public/login/index.html) | [`web/public/login/login.css`](file:///c:/DEVELOPMENT/banking-demo/banking-demo/web/public/login/login.css), [`web/public/login/login.js`](file:///c:/DEVELOPMENT/banking-demo/banking-demo/web/public/login/login.js) | Creative Login Screen: Vibrant sunny yellow background, animated 2D boy character walking behind centered white login card, eye covering on password, code snippet inspection dock. |
