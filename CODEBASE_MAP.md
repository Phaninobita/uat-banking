...
| **Creative Vault Login** | `/login` | [`web/public/login/index.html`](file:///c:/DEVELOPMENT/banking-demo/banking-demo/web/public/login/index.html) | [`web/public/login/login.css`](file:///c:/DEVELOPMENT/banking-demo/banking-demo/web/public/login/login.css), [`web/public/login/login.js`](file:///c:/DEVELOPMENT/banking-demo/banking-demo/web/public/login/login.js) | Creative Login Screen: Articulated SVG Goblin character (pacing, peeking, covering eyes on password, peeking through fingers on show cipher), customer & RM authentication, demo pills. |
